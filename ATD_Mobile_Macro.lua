...
local RecordBtn = createButton("Record",UDim2.new(0.05,0,0.67,0),Color3.fromRGB(255,170,0))
local StopRecordBtn = createButton("Stop Rec",UDim2.new(0.365,0,0.67,0),Color3.fromRGB(255,80,80))
local PlayBtn = createButton("Play",UDim2.new(0.68,0,0.67,0),Color3.fromRGB(0,170,255))
local StopBtn = createButton("Stop",UDim2.new(0.05,0,0.84,0),Color3.fromRGB(255,70,70))
local ClearBtn = createButton("Clear",UDim2.new(0.365,0,0.84,0),Color3.fromRGB(100,100,100))
local LoopBtn = createButton("Loop OFF",UDim2.new(0.68,0,0.84,0),Color3.fromRGB(140,0,255))
