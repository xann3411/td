...
UIS.InputChanged:Connect(function(input)
    if fbDragging and input.UserInputType == Enum.UserInputType.MouseMovement then
...
-- Scale slider drag logic
local scaleDragging = false
ScaleBtn.MouseButton1Down:Connect(function() scaleDragging = true end)
UIS.InputEnded:Connect(function(input)
    if input.UserInputType == Enum.UserInputType.MouseButton1 then
        scaleDragging = false
    end
