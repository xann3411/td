-- ================================================
-- Auto Roll Script v4 — Random Anime Tower Defense (mobile ScrollingFrame fix)
...
local WIN_H = IsMobile and 520 or 560
local Win=Instance.new("Frame")
Win.Size=UDim2.new(0,W,0,WIN_H); Win.AutomaticSize=Enum.AutomaticSize.None
...
-- Body — ScrollingFrame fixes AutomaticSize+UIListLayout black-box bug on mobile
Body=Instance.new("ScrollingFrame")  -- intentional upvalue for Section()
Body.Size=UDim2.new(1,0,1,-38); Body.Position=UDim2.new(0,0,0,38)
Body.CanvasSize=UDim2.new(0,0,0,0)
Body.AutomaticCanvasSize=Enum.AutomaticSize.Y
Body.ScrollBarThickness=4; Body.ScrollBarImageColor3=C.BORDER
Body.BackgroundTransparency=1; Body.BorderSizePixel=0; Body.LayoutOrder=1; Body.Parent=Win
...
-- ================================================
Section("Status")
local SC=Instance.new("Frame"); SC.Size=UDim2.new(1,0,0,82); SC.BackgroundColor3=C.CARD; SC.Parent=Body; Corner(SC,7)
...
local RF=Instance.new("Frame"); RF.Size=UDim2.new(1,0,0,120); RF.BackgroundColor3=C.CARD; RF.Parent=Body; Corner(RF,7)
...
print("[AutoRoll v4] Loaded — ScrollingFrame mobile fix")
