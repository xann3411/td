...
-- ================================================
-- GOOMBA HUB FULL VISUAL REWORK
-- ================================================

pcall(function()
    local blur = Instance.new("BlurEffect")
    blur.Name = "GoombaBlur"
    blur.Size = 14
    blur.Parent = game:GetService("Lighting")
end)

print("[Goomba Hub] Full visual rework loaded")
...
local HTitle = Label(Header, "Goomba Hub", FONT_LG, C.WHITE, FONT_BOLD)
...
SearchBox.Position = UDim2.new(1,-260,0.5,-14)
...
ContentHeader.BackgroundColor3 = Color3.fromRGB(15,15,18)
